...
<body>
	<div class="overlay">
	   ...
	   <div class="awalan">
	     ...
	     <label style="font-size:16px">pesanuntukmu</label>
	   </div>
	</div>
  </div>
  ...
  <div class="container" id="container">
    <p class="titleC"><b>Alooo Kakak! 🫣💗</b></p>
    <script>teksAnimasi = [
  "Tetap semangat ya, Kak. Aku tahu peran yang kamu jalani tidak selalu mudah. Terima kasih karena selalu bersedia mendengarkan aku 🤍",
  "<br><i>Every day, I’m truly grateful for you</i>. Cara kamu mendengarkan dengan sabar membuat aku merasa dihargai.",
  "<br><b>Terima kasih banyak, Kak,</b><br>atas kesediaan kamu untuk selalu mendengarkan dan memberi dukungan dengan tulus.",
];
